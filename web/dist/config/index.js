...
;(function () {
  ...
  // window.SITE_CONFIG['baseUrl'] = 'http://114.116.19.246:8080/renren-fast';
   window.SITE_CONFIG['baseUrl'] = 'http://' + window.location.host + '/renren-fast';

  // cdn地址 = 域名 + 版本号
  window.SITE_CONFIG['domain']  = './'; // 域名
  window.SITE_CONFIG['version'] = '2206122339';   // 版本号(年月日时分)
...
;(function() {
  var resList = {
    icon: window.SITE_CONFIG.cdnUrl + '/static/img/icon.ico',
    css: [
